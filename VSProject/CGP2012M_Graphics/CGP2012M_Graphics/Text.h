...
public:
	...
	*/
		...
		: offset(glm::vec2(offsetX, offsetY)), alignMode(alignMode)
	{
		...
		vert = JN_Shader(JN_Shader::ShaderType::Vertex, "..//..//Assets//Shaders//shader_Text.vert");
		frag = JN_Shader(JN_Shader::ShaderType::Fragment, "..//..//Assets//Shaders//shader_Text.frag");
